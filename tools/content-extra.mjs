...
export const DISTRICT_EXTRA = {
  ...
  vrakuna: ['Opravy WC a batérií v bytoch', 'Prečistenie odpadov a stúpačiek', 'Výmena bojlerov s odvozom starého', 'Zapojenie práčok vrátane ventilu', 'Uzávery a prípojky v rodinnej zástavbe', 'Výmena sifónov'],
  ...
  jarovce: ['Prípojky a hlavné uzávery v domoch', 'Čerpadlá a tlakové nádoby', 'Prečistenie odpadov', 'Servis kúrenia', 'Výmena batérií a sifónov', 'Opravy WC'],
